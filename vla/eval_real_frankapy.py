...
def _eval():
    ...
    model_path = os.path.join(base_path, "model_299.pth")
    ...
    instructions = [[["put_bottle_in_microwave"]]]
    ...
    try:
        for step in range(episode_length-1):
            ...
            vis_pcd_with_end_pred(observation_origen["3rd"]["pcd"], observation_origen["3rd"]["rgb"], end_pose, target_point.position_quaternion_claw)
