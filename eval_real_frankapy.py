...
def _eval():
    ...
    model_path = os.path.join(base_path, "with_detection_300_debug_color.pth") 
    ...
    # instructions = [[["place the sneaker in the green plate"]]]
    instructions = [[["place the tennis ball in the green plate"]]]
