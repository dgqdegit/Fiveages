...
def get_cam_extrinsic(type):
    if type == "3rd":
        ...
        # trans=np.array([1.054796952981975, -0.06475333119238524, 0.6258487699306973])
        # quat=np.array([-0.6333618117159686, -0.6314373615890897, 0.30614530833320514,0.3262126975377288]) # x y z w
        transform = [[ 0.01006951 , 0.42438194 ,-0.90542729 , 0.69546442],
 [ 0.99589235 ,-0.085738  , -0.02911058 ,-0.55758988],
 [-0.08998353, -0.90141498 ,-0.42350206 , 0.54969246],
 [ 0.       ,   0.      ,    0.    ,      1.        ]] # 这里直接使用标定后的外参矩阵
...
class Camera:
    def __init__(self, camera_type="all", timestamp_tolerance_ms=80):
        static_serial_number = 32293157   #更换为自己的相机序列号
...
if __name__ == "__main__":
    ...
    def vis_pcd(pcd, rgb):
        ...
        o3d.visualization.draw_geometries([pcd, axis_origin])
        # Save to PLY file
